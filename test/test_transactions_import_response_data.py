...
class TestTransactionsImportResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionsImportResponseData:
        """Test TransactionsImportResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionsImportResponseData`
        """
        model = TransactionsImportResponseData()
        if include_optional:
