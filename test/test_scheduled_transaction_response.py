...
class TestScheduledTransactionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduledTransactionResponse:
        """Test ScheduledTransactionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduledTransactionResponse`
        """
        model = ScheduledTransactionResponse()
        if include_optional:
            return ScheduledTransactionResponse(
                data = ynab_openapi.models.scheduled_transaction_response_data.ScheduledTransactionResponse_data(
