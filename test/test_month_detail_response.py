...
class TestMonthDetailResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MonthDetailResponse:
        """Test MonthDetailResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonthDetailResponse`
        """
        model = MonthDetailResponse()
        if include_optional:
            return MonthDetailResponse(
                data = ynab_openapi.models.month_detail_response_data.MonthDetailResponse_data(
                    month = null, )
            )
        else:
            return MonthDetailResponse(
