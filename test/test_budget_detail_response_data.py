...
class TestBudgetDetailResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BudgetDetailResponseData:
        """Test BudgetDetailResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BudgetDetailResponseData`
        """
        model = BudgetDetailResponseData()
        if include_optional:
