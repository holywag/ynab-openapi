...
class TestScheduledTransactionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduledTransactionsResponse:
        """Test ScheduledTransactionsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduledTransactionsResponse`
        """
        model = ScheduledTransactionsResponse()
        if include_optional:
            return ScheduledTransactionsResponse(
                data = ynab_openapi.models.scheduled_transactions_response_data.ScheduledTransactionsResponse_data(
