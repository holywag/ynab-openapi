...
class TestSaveCategoryResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SaveCategoryResponseData:
        """Test SaveCategoryResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveCategoryResponseData`
        """
        model = SaveCategoryResponseData()
        if include_optional:
            return SaveCategoryResponseData(
                category = ynab_openapi.models.category.Category(
                    id = '', 
                    category_group_id = '', 
                    category_group_name = '', 
                    name = '', 
