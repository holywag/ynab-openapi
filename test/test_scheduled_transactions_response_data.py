...
class TestScheduledTransactionsResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduledTransactionsResponseData:
        """Test ScheduledTransactionsResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduledTransactionsResponseData`
        """
        model = ScheduledTransactionsResponseData()
        if include_optional:
