    ...
    def make_instance(self, include_optional) -> BudgetDetail:
        ...
        if include_optional:
            return BudgetDetail(
                ...
                date_format = ynab_openapi.models.date_format.DateFormat(
                    format = '', ),
                currency_format = ynab_openapi.models.currency_format.CurrencyFormat(
                    iso_code = '', 
                    example_format = '', 
                    decimal_digits = 56, 
                    decimal_separator = '', 
                    ...
                    display_symbol = True, ),
                accounts = [
                    ynab_openapi.models.account.Account(
                        id = '', 
                        name = '', 
                        type = 'checking', 
                        on_budget = True, 
                ...
                payees = [
                    ynab_openapi.models.payee.Payee(
                        id = '', 
                        name = '', 
                        transfer_account_id = '', 
                        deleted = True, )
                ...
                category_groups = [
                    ynab_openapi.models.category_group.CategoryGroup(
                        id = '', 
                        name = '', 
                        hidden = True, 
                        deleted = True, )
                ...
                transactions = [
                    ynab_openapi.models.transaction_summary.TransactionSummary(
                        id = '', 
                ...
                subtransactions = [
                    ynab_openapi.models.sub_transaction.SubTransaction(
                        id = '', 
                        transaction_id = '', 
                        amount = 56, 
                        memo = '', 
                ...
                scheduled_transactions = [
                    ynab_openapi.models.scheduled_transaction_summary.ScheduledTransactionSummary(
                        id = '', 
                ...
                scheduled_subtransactions = [
                    ynab_openapi.models.scheduled_sub_transaction.ScheduledSubTransaction(
                        id = '', 
