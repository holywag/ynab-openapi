...
class TestCategoriesResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CategoriesResponseData:
        """Test CategoriesResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoriesResponseData`
        """
        model = CategoriesResponseData()
        if include_optional:
