...
class TestHybridTransactionsResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HybridTransactionsResponseData:
        """Test HybridTransactionsResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HybridTransactionsResponseData`
        """
        model = HybridTransactionsResponseData()
        if include_optional:
