...
class TestPayeeLocationResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PayeeLocationResponseData:
        """Test PayeeLocationResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayeeLocationResponseData`
        """
        model = PayeeLocationResponseData()
        if include_optional:
            return PayeeLocationResponseData(
                payee_location = ynab_openapi.models.payee_location.PayeeLocation(
                    id = '', 
                    payee_id = '', 
                    latitude = '', 
                    longitude = '', 
