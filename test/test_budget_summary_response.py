...
class TestBudgetSummaryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BudgetSummaryResponse:
        """Test BudgetSummaryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BudgetSummaryResponse`
        """
        model = BudgetSummaryResponse()
        if include_optional:
            return BudgetSummaryResponse(
                data = ynab_openapi.models.budget_summary_response_data.BudgetSummaryResponse_data(
                    budgets = [
                        ynab_openapi.models.budget_summary.BudgetSummary(
                            id = '', 
                            name = '', 
                    ...
                    default_budget = ynab_openapi.models.budget_summary.BudgetSummary(
                        id = '', 
                        name = '', 
                        last_modified_on = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        first_month = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
