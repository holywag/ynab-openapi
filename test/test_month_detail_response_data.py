...
class TestMonthDetailResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MonthDetailResponseData:
        """Test MonthDetailResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonthDetailResponseData`
        """
        model = MonthDetailResponseData()
        if include_optional:
