...
class TestTransactionsResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionsResponseData:
        """Test TransactionsResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionsResponseData`
        """
        model = TransactionsResponseData()
        if include_optional:
