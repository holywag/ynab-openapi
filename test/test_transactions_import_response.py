...
class TestTransactionsImportResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionsImportResponse:
        """Test TransactionsImportResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionsImportResponse`
        """
        model = TransactionsImportResponse()
        if include_optional:
            return TransactionsImportResponse(
                data = ynab_openapi.models.transactions_import_response_data.TransactionsImportResponse_data(
                    transaction_ids = [
                        ''
                        ], )
            )
