...
class TestScheduledTransactionResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduledTransactionResponseData:
        """Test ScheduledTransactionResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduledTransactionResponseData`
        """
        model = ScheduledTransactionResponseData()
        if include_optional:
