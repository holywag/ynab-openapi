...
from ynab_openapi.api_client import ApiClient, RequestSerialized
from ynab_openapi.api_response import ApiResponse
from ynab_openapi.rest import RESTResponseType
...
class TransactionsApi:
    ...
    def create_transaction(
        ...
        data: Annotated[PostTransactionsWrapper, Field(description="The transaction or transactions to create.  To create a single transaction you can specify a value for the `transaction` object and to create multiple transactions you can specify an array of `transactions`.  It is expected that you will only provide a value for one of these objects.")],
    ...
    def get_transactions(
        self,
        budget_id: Annotated[StrictStr, Field(description="The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).")],
        since_date: Annotated[Optional[date], Field(description="If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30).")] = None,
        type: Annotated[Optional[StrictStr], Field(description="If specified, only transactions of the specified type will be included. \"uncategorized\" and \"unapproved\" are currently supported.")] = None,
    ...
    @validate_call
    def get_transactions_by_account_without_preload_content(
        self,
        budget_id: Annotated[StrictStr, Field(description="The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).")],
        account_id: Annotated[StrictStr, Field(description="The id of the account")],
        since_date: Annotated[Optional[date], Field(description="If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30).")] = None,
    ...
    @validate_call
    def get_transactions_by_category_without_preload_content(
        self,
        budget_id: Annotated[StrictStr, Field(description="The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).")],
        category_id: Annotated[StrictStr, Field(description="The id of the category")],
        since_date: Annotated[Optional[date], Field(description="If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30).")] = None,
    ...
    @validate_call
    def get_transactions_by_payee_without_preload_content(
        self,
        budget_id: Annotated[StrictStr, Field(description="The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).")],
        payee_id: Annotated[StrictStr, Field(description="The id of the payee")],
        since_date: Annotated[Optional[date], Field(description="If specified, only transactions on or after this date will be included.  The date should be ISO formatted (e.g. 2016-12-30).")] = None,
