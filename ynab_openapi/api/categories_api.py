...
class CategoriesApi:
    ...
    def update_month_category(
        ...
        month: Annotated[date, Field(description="The budget month in ISO format (e.g. 2016-12-01) (\"current\" can also be used to specify the current calendar month (UTC))")],
        category_id: Annotated[StrictStr, Field(description="The id of the category")],
        data: Annotated[PatchMonthCategoryWrapper, Field(description="The category to update.  Only `budgeted` amount can be updated and any other fields specified will be ignored.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
