    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.payee_locations:
            for _item in self.payee_locations:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.category_groups:
            for _item in self.category_groups:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.scheduled_transactions:
            for _item in self.scheduled_transactions:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.scheduled_subtransactions:
            for _item in self.scheduled_subtransactions:
                if _item:
                    _items.append(_item.to_dict())
