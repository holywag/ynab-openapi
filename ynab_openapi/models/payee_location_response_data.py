...
class PayeeLocationResponseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payee_location"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of payee_location
        if self.payee_location:
            _dict['payee_location'] = self.payee_location.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payee_location": PayeeLocation.from_dict(obj["payee_location"]) if obj.get("payee_location") is not None else None
        })
        return _obj
