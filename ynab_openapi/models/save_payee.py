...
class SavePayee(BaseModel):
    ...
    SavePayee
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(default=None, description="The name of the payee. The name must be a maximum of 500 characters.")
