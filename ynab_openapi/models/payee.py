...
class Payee(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    transfer_account_id: Optional[StrictStr] = Field(default=None, description="If a transfer payee, the `account_id` to which this payee transfers to")
    deleted: StrictBool = Field(description="Whether or not the payee has been deleted.  Deleted payees will only be included in delta requests.")
