...
class CategoriesResponseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category_groups", "server_knowledge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category_groups": [CategoryGroupWithCategories.from_dict(_item) for _item in obj["category_groups"]] if obj.get("category_groups") is not None else None,
