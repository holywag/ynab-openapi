...
class SaveSubTransaction(BaseModel):
    ...
    payee_id: Optional[StrictStr] = Field(default=None, description="The payee for the subtransaction.")
    ...
    category_id: Optional[StrictStr] = Field(default=None, description="The category for the subtransaction.  Credit Card Payment categories are not permitted and will be ignored if supplied.")
