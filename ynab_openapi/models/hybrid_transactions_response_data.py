...
class HybridTransactionsResponseData(BaseModel):
    ...
    server_knowledge: Optional[StrictInt] = Field(default=None, description="The knowledge of the server")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [HybridTransaction.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
