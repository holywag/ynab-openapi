...
class MonthDetail(BaseModel):
    ...
    categories: List[Category] = Field(description="The budget month categories.  Amounts (budgeted, activity, balance, etc.) are specific to the {month} parameter specified.")
    __properties: ClassVar[List[str]] = ["month", "note", "income", "budgeted", "activity", "to_be_budgeted", "age_of_money", "deleted", "categories"]
