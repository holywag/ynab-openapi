...
json = "{}"
# create an instance of SaveTransactionWithOptionalFields from a JSON string
save_transaction_with_optional_fields_instance = SaveTransactionWithOptionalFields.from_json(json)
# print the JSON string representation of the object
print(SaveTransactionWithOptionalFields.to_json())

# convert the object into a dict
save_transaction_with_optional_fields_dict = save_transaction_with_optional_fields_instance.to_dict()
# create an instance of SaveTransactionWithOptionalFields from a dict
save_transaction_with_optional_fields_from_dict = SaveTransactionWithOptionalFields.from_dict(save_transaction_with_optional_fields_dict)
```
