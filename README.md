...
*ScheduledTransactionsApi* | [**create_scheduled_transaction**](docs/ScheduledTransactionsApi.md#create_scheduled_transaction) | **POST** /budgets/{budget_id}/scheduled_transactions/{scheduled_transaction_id} | Create a single scheduled transaction
